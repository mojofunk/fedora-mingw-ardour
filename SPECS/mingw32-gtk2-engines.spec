...
# no .la, please
find $RPM_BUILD_ROOT%{_mingw32_libdir} -name "*.la" | xargs rm

# sanitize permissions
find $RPM_BUILD_ROOT%{_mingw32_datadir}/themes -type d -exec chmod 755 {} \;
find $RPM_BUILD_ROOT%{_mingw32_datadir}/themes -type f -name "*.png" -exec chmod 644 {} \;
find $RPM_BUILD_ROOT%{_mingw32_datadir}/themes -name "gtkrc*" -perm +111 -exec chmod 644 {} \;

# no thanks
rm -rf $RPM_BUILD_ROOT%{_mingw32_datadir}/themes/Redmond
rm -rf $RPM_BUILD_ROOT%{_mingw32_libdir}/gtk-2.0/2.4.0/engines/libredmond95.so
...
%attr (755, root, root) %{_mingw32_libdir}/gtk-2.0/2.10.0/engines/*.dll
%{_mingw32_libdir}/gtk-2.0/2.10.0/engines/*.dll.a
%{_mingw32_datadir}/themes/*
%{_mingw32_datadir}/gtk-engines
%{_mingw32_libdir}/pkgconfig/gtk-engines-2.pc

%files static
%defattr(-,root,root,-)
%{_mingw32_libdir}/gtk-2.0/2.10.0/engines/*.a

%changelog
* Wed Nov 9 2011 Tim Mayberry <mojofunk@gmail.com> - 2.20.2-2
- use global instead of define for macros

* Thu Jun 30 2011 Tim Mayberry <mojofunk@gmail.com> - 2.20.2-1
- initial mingw build
